...
def test_parser(dst_file, print_read_data=False, add_xmax=False):
    ...
    if add_xmax:
        ...
        xmax_dir = f"{ceph_root}/tasdmc_dstbank/qgsii04proton/080417_160603/Em1_bsdinfo"
    ...
    if print_read_data and (data is not None):
        print(f"\nConverted arrays:\n---")
...
if __name__ == "__main__":
    # dst_file = (
    #     f"{ceph_root}/INR_group/cluster82/grisha/tasdmc_SIBYLL_fe/p2/"
    #     "DAT013520.corsika77420.SIBYLL.tar.gz.spctr1.1945.noCuts.dst.gz"
    # )
    # dst_file = f"{ceph_root}/tasdmc_dstbank/qgsii04proton/080417_160603/Em1_bsdinfo/DAT055402_gea.rufldf.dst.gz"
    # dst_file = f"{ceph_root}/tasdmc_dstbank/qgsii04proton/080417_160603/Em1_bsdinfo/DAT051419_gea.rufldf.dst.gz"
    # dst_file = f"{ceph_root}/tasdmc_dstbank/tax4/qgsii04proton/north/221101to240124/DAT010019_gea.rufldf.dst.gz"
    # dst_file = f"{ceph_root}/tasdmc_dstbank/qgsii04nitrogen/080417_160603/Em1_bsdinfo/DAT081325_gea.rufldf.dst.gz"

    dst_file = f"{ceph_root}/tasdmc_dstbank/qgsii04iron/080417_160603/Em1_bsdinfo/XXXX20/DAT000020_gea.rufldf.dst.gz"
